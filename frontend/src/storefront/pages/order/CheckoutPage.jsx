...
import PaymentSection from '@/storefront/components/order/components/PaymentSection'
import { getImageUrl, formatPrice } from '@/shared/utils/productUtils'
import { selectSelectedAddress, setLastOrder, setPlacingOrder, setOrderError } from '@/storefront/store/checkoutStore'
import { selectCartTotals, clearCart } from '@/storefront/store/cartSlice'
import { useCreateOrder } from '@/storefront/hooks/order/useOrders'
import { deliveryZonesAPI } from '@/shared/services/api'
